...
public interface ITicketAutoAction {
    ...
    ///
    /// <see href="https://doc.alvao.com/en/11.2/modules/alvao-sd-custom-apps/applications/ticket-custom-actions-by-events/ticket-custom-actions#OnTicketChanged"/>
    ...
    /// <param name="personId">The ID of the user (tPerson.iPersonId) who executed the event on the ticket. In some cases it could be the system, then the value is NULL.</param>
    ///
    /// <see href="https://doc.alvao.com/en/11.2/modules/alvao-sd-custom-apps/applications/ticket-custom-actions-by-events/ticket-custom-actions#OnTicketCreated"/>
