...
public static class TicketProcess {
    ...
    public static void EvaluateRelatedTicketRules(int ticketId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<TicketProcessColumnModel> GetColumns(int processId, CultureInfo language = null) { throw new System.NotImplementedException(); }
}
