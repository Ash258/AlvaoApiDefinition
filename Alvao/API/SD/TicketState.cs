...
public static class TicketState {
    ...
    public static Alvao.API.Common.Model.Database.TicketState GetByBehaviorId(TicketStateBehavior.BehaviorId behaviorId, int sectionId) { throw new System.NotImplementedException(); }
    ...
    /// <returns>Request state (TicketState)</returns>
    public static Alvao.API.Common.Model.Database.TicketState GetById(int stateId) { throw new System.NotImplementedException(); }
    ...
    /// <returns>Request state (TicketState)</returns>
    public static Alvao.API.Common.Model.Database.TicketState GetCurrentStateByTicketId(int ticketId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<StateRequiredColumnModel> GetEmptyRequiredFieldsForState(int ticketId, int stateId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<Alvao.API.Common.Model.Database.TicketState> GetFromProcess(int processId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<RelatedTicketRuleModel> GetRelatedTicketRules(int stateId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<Alvao.API.Common.Model.Database.TicketState> GetStatesFromProcess(int processId) { throw new System.NotImplementedException(); }
    ...
    public static bool IsAdHocApproval(int ticketStateId) { throw new System.NotImplementedException(); }
}
