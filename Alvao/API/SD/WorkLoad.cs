...
public static class WorkLoad {
    ...
    public static void Add(tWorkLoad model) { throw new NotImplementedException(); }
    ...
    public static void Delete(int id) { throw new NotImplementedException(); }
    ...
    /// <param name="model">Labor contract model.</param>
    /// <exception cref="ArgumentNullException">Throws when model is null.</exception>
    public static void Update(tWorkLoad model) { throw new NotImplementedException(); }
}
