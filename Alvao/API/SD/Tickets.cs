...
public static class Tickets {
    ...
    /// Throws when request with destinationTicketId or one of ticketsIds does not exists or ticketsIds contains destinationTicketId or ticketsIds has value.
    /// </exception>
    /// <returns>Cyclic relation exists</returns>
    public static bool CheckCyclicRelationsBeforeMergingTicket(IEnumerable<int> ticketsIds, int destinationTicketId) { throw new System.NotImplementedException(); }
    ...
    /// Throws when at least one column in columns is forbidden.
    /// </exception>
    /// <returns>List of dynamic objects. Each object has properties specified in columns parameter.</returns>
    public static IEnumerable<dynamic> GetCustomTicketList(string columns, string filterCondition, string sorting, int localeId, int maxRecords, int? personId) { throw new System.NotImplementedException(); }
    ...
    /// <exception cref="ArgumentException">
    /// Throws when request with destinationTicketId or one of sourceTicketsId does not exists or sourceTicketsId contains destinationTicketId or sourceTicketsId has value.
    /// </exception>
    /// <returns>Created act ID (tAct.iActId)</returns>
    public static int Merge(IEnumerable<int> sourceTicketsId, int destinationTicketId, bool removeRelations) { throw new System.NotImplementedException(); }
}
