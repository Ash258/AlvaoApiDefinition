...
public static class Approval {
    ...
    public static void AddApprovers(int ticketId, IEnumerable<int> approverIds, int? personId, HtmlTextModel commentForApprover, DateTime? approvalBegin = null) { throw new NotImplementedException(); }
    ...
    public static void Approve(int ticketId, HtmlTextModel comment, int? personId = null, int? nextStep = null, bool finishApproval = false, bool ignoreRequiredColumns = false) { throw new NotImplementedException(); }
    ...
    /// <param name="ticketId">Request ID (tHdTicket.iHdTicketId)</param>
    /// <exception cref="TicketApprovalNotInProgressException">Throws when request approval is not in progress.</exception>
    public static void Cancel(int ticketId) { throw new NotImplementedException(); }
    ...
    public static void CancelItems(int ticketId, IEnumerable<int> approvalItemIds) { throw new NotImplementedException(); }
    ...
    public static int EnterByPerson(int ticketId, int approverPersonId, double expirationHours, int? personId, HtmlTextModel approvalNotice, DateTime? approvalBegin = null) { throw new NotImplementedException(); }
    ...
    /// <returns>Approval step ID (tHdTicketApprovalItem.iHdTicketApprovalItemId)</returns>
    public static int EnterBySchema(int ticketId, int schemaId, int? personId, HtmlTextModel approvalNotice, DateTime? approvalBegin = null, int? initialSchemaStep = null) { throw new NotImplementedException(); }
    ...
    /// <exception cref="TicketApprovalNotInProgressException">Throws when request approval is not in progress.</exception>
    public static void Expire(int ticketId, bool ignoreRequiredColumns = false) { throw new NotImplementedException(); }
    ...
    public static tHdTicketApprovalItem GetApprovalItemById(int approvalItemId) { throw new NotImplementedException(); }
    ...
    /// <param name="ticketId">Request ID (tHdTicket.iHdTicketId)</param>
    public static IEnumerable<tHdTicketApprovalItem> GetCurrentApprovalItems(int ticketId) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<int> GetTicketIdsForExpiration() { throw new NotImplementedException(); }
    ...
    public static void Reject(int ticketId, HtmlTextModel comment, int? personId = null, bool ignoreRequiredColumns = false) { throw new NotImplementedException(); }
}
