...
public static class News {
    ...
    public static void DeleteAllTranslations(int newsId) { throw new System.NotImplementedException(); }
    ...
    public static void Send(int newsId, bool sendToRequesters, bool sendToSectionTeam, string specificRecipients) { throw new System.NotImplementedException(); }
    ...
    public static void Send(int newsId, List<string> recipients, string newsLink) { throw new System.NotImplementedException(); }
    ...
    public static bool Translate(int newsId) { throw new System.NotImplementedException(); }
    ...
    /// <returns>Whether the translation was successful.</returns>
    public static bool TranslateToLanguage(int newsId, int localeId) { throw new System.NotImplementedException(); }
}
