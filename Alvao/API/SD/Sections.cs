...
public static class Sections {
    ...
    public static MemoryStream Export(int? sectionId, bool includeSubtree) { throw new System.NotImplementedException(); }
    ...
    public static MemoryStream ExportSections(int? sectionId, bool includeSubtree) { throw new System.NotImplementedException(); }
    ...
    /// <returns>Memory stream with xml</returns>
    public static ImportViewModel Import(int? sectionId, AlvaoConfigurationXmlModel sections, int personId) { throw new System.NotImplementedException(); }
    ...
    public static ImportViewModel ImportSections(int? sectionId, AlvaoConfigurationXmlModel sections, int personId) { throw new System.NotImplementedException(); }
    ...
    /// <param name="personId">Person id who imports sections</param>
    /// <returns>Memory stream with xml</returns>
    public static ImportViewModel ValidateBeforeImport(int? sectionId, AlvaoConfigurationXmlModel sections, int personId) { throw new System.NotImplementedException(); }
    ...
    public static ImportViewModel ValidateSectionsBeforeImport(int? sectionId, AlvaoConfigurationXmlModel sections, int personId) { throw new System.NotImplementedException(); }
}
