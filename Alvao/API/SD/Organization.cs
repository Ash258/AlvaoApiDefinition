...
public static class Organization {
    ...
    public static int Create(tAccount organization) { throw new NotImplementedException(); }
    ...
    public static tAccount GetById(int id) { throw new NotImplementedException(); }
    ...
    public static tAccount GetByName(string name) { throw new NotImplementedException(); }
}
