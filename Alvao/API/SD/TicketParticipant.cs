...
public static class TicketParticipant {
    ...
    public static void Add(int ticketId, IEnumerable<int> idsToAdd) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tPerson> Get(int ticketId, bool ignoreRequester = false) { throw new NotImplementedException(); }
    ...
    /// <exception cref="ArgumentException">Throws when ticketId does not exist.</exception>
    /// <exception cref="UnauthorizedAccessException">Throws when current person is not requester, ticket participant, member of section team or system user.</exception>
    public static void Remove(int ticketId, IEnumerable<int> idsToRemove) { throw new NotImplementedException(); }
}
