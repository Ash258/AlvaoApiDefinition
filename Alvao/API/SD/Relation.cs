...
public static class Relation {
    ...
    public static int Create(int beginTicketId, int endTicketId, int ticketRelationTypeId, int personId) { throw new NotImplementedException(); }
    ...
    public static void CreateWithObject(int ticketId, int objectId, int createdPersonId, bool callCustomAction) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<int> GetLinkedNodes(int ticketId) { throw new NotImplementedException(); }
    ...
    /// <param name="callCustomAction">If true, ticket changed event is triggered.</param>
    public static void RemoveMultipleWithObject(IEnumerable<int> ticketIds, int objectId, int removedPersonId, bool callCustomAction) { throw new NotImplementedException(); }
    ...
    /// <param name="removedPersonId">Person ID (who removed link) (tPerson.iPersonId)</param>
    /// <param name="callCustomAction">If true, ticket changed event is triggered.</param>
    public static void RemoveWithObjectsByIds(int ticketId, IEnumerable<int> ticketNodeIds, int removedPersonId, bool callCustomAction) { throw new NotImplementedException(); }
    ...
    public static void SynchronizeWithObjectsByObjectIds(int ticketId, IEnumerable<int> objectIds, int changedPersonId, bool callCustomAction) { throw new NotImplementedException(); }
}
