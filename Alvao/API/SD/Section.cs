...
public static class Section {
    ...
    /// </exception>
    public static void AddRight(tHdSectionRights model, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// <param name="authorId">Person ID (who added right) (tPerson.iPersonId)</param>
    /// <exception cref="ArgumentNullException">
    /// Throws when model, rolesIds or personsIds is null.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when section does not exist or at least one role from rolesIds or person from personsIds does not exist.
    /// </exception>
    public static void AddRights(tHdSectionRights model, IEnumerable<int> rolesIds, IEnumerable<int> personsIds, int authorId) { throw new System.NotImplementedException(); }
    /// <summary>Adds multiple service rights to person and creates records in log.</summary>
    ...
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when sectionIds is null or at least one of them does not exist or when model is not valid.
    /// </exception>
    public static void AddRights(tHdSectionRights model, IEnumerable<int> sectionIds, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when service does not exist or model is not valid.
    /// </exception>
    public static void AddSlaRight(tSlaRights model, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when at least one role in rolesIds, person in personsIds or service does not exist.
    /// </exception>
    public static void AddSlaRights(tSlaRights model, IEnumerable<int> rolesIds, IEnumerable<int> personsIds, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// <exception cref="ArgumentException">
    /// Throws when destinationSectionId or sourceSectionId does not exists.
    /// </exception>
    /// <exception cref="InvalidOperationException">
    /// Throws when destinationSectionId or sourceSectionId is deleted.
    /// </exception>
    public static void Copy(int sourceSectionId, int? destinationSectionId, bool copyWithSubtree, int authorId) { throw new System.NotImplementedException(); }
    ...
    public static void CopySections(int sourceSectionId, int? destinationSectionId, bool copyWithSubtree, int authorId) { throw new System.NotImplementedException(); }
    ...
    public static int Create(tHdSection sectionModel) { throw new System.NotImplementedException(); }
    ...
    /// <exception cref="ArgumentNullException">
    /// Throws when sectionsId is null.
    /// </exception>
    public static void DeleteAllRights(int[] sectionsId, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// Throws when sectionsId is null.
    /// </exception>
    public static void DeleteAllSlaRights(int[] sectionsId, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// <param name="authorId">Person ID (who removed right) (tPerson.iPersonId)</param>
    /// <exception cref="ArgumentException">
    /// Throws when section right with rightId does not exist.
    /// </exception>
    public static void DeleteRight(int rightId, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// <param name="authorId">Person ID (who removed right) (tPerson.iPersonId)</param>
    /// <exception cref="ArgumentNullException">
    /// Throws when rightIds is null.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when at least one section right in rightIds does not exist.
    /// </exception>
    public static void DeleteRights(int[] rightIds, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// <param name="authorId">Person ID (who removed permission) (tPerson.iPersonId)</param>
    /// <exception cref="ArgumentNullException">
    /// Throws when slaRightIds is null.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when at least one sla right in slaRightIds does not exist.
    /// </exception>
    public static void DeleteSlaRights(int[] slaRightIds, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// <exception cref="ArgumentException">
    /// Throws when service with sectionId does not exists.
    /// </exception>
    /// <exception cref="InheritanceException">
    /// Throws when infinite recursion is detected.
    /// </exception>
    public static void DisableInheritance(int sectionId, bool auditLogChanges = true) { throw new System.NotImplementedException(); }
    ...
    /// Throws when infinite recursion is detected.
    /// </exception>
    public static void EnableInheritance(int sectionId, bool auditLogChanges = true) { throw new System.NotImplementedException(); }
    ...
    public static tHdSection GetById(int sectionId) { throw new System.NotImplementedException(); }
    /// <summary>Returns section database model.</summary>
    ...
    /// <returns>Request model (tHdTicket)</returns>
    public static tHdSection GetByTicketId(int ticketId) { throw new System.NotImplementedException(); }
    ...
    /// <param name="sectionId">Section ID (tHdSection.iHdSectionId)</param>
    public static int GetOnlySolverId(int ticketId, int sectionId) { throw new System.NotImplementedException(); }
    ...
    public static int GetSectionOnlySolverId(int ticketId, int sectionId) { throw new System.NotImplementedException(); }
    ...
    public static bool IsInheritanceEnabled(int sectionId) { throw new System.NotImplementedException(); }
    ...
    public static bool IsSectionEmail(string email) { throw new System.NotImplementedException(); }
    ...
    public static bool IsSolverGroup(int sectionId, int roleId) { throw new System.NotImplementedException(); }
    ...
    /// </exception>
    /// <exception cref="InvalidOperationException">
    /// Throws when newParentSectionId is deleted.
    /// </exception>
    public static void Move(int sectionId, int? newParentSectionId) { throw new System.NotImplementedException(); }
    ...
    public static void MoveSections(int sectionId, int? newParentSectionId) { throw new System.NotImplementedException(); }
    ...
    /// Throws when infinite recursion is detected.
    /// </exception>
    public static void RecalculateInheritance(int sectionId, bool auditLogChanges = false) { throw new System.NotImplementedException(); }
    ...
    /// <exception cref="ArgumentNullException">
    /// Throws when destinationSections is null.
    /// </exception>
    public static void ReplaceRights(int sourceSectionId, int[] destinationSections, int authorId) { throw new System.NotImplementedException(); }
    ...
    public static void ReplaceSectionsRights(int sourceSectionId, int[] destinationSections, int authorId) { throw new System.NotImplementedException(); }
    ...
    public static void ReplaceSectionsSlaRights(int sourceSectionId, int[] destinationSections, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// Throws when destinationSections is null.
    /// </exception>
    public static void ReplaceSlaRights(int sourceSectionId, int[] destinationSections, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when service or requester role does not exist or model is not valid.
    /// </exception>
    public static void UpdateRight(tHdSectionRights model, int authorId) { throw new System.NotImplementedException(); }
    ...
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when section does not exist or model is not valid.
    /// </exception>
    public static void UpdateSlaRight(tSlaRights model, int authorId) { throw new System.NotImplementedException(); }
}
