...
public static class Webhook {
    ...
    public static int Create(Alvao.API.Common.Model.Database.Webhook webhook) { throw new NotImplementedException(); }
    ...
    public static bool Delete(Alvao.API.Common.Model.Database.Webhook webhook) { throw new NotImplementedException(); }
    ...
    public static bool Disable(int webhookId) { throw new NotImplementedException(); }
    ...
    public static bool Enable(int webhookId) { throw new NotImplementedException(); }
    ...
    public static Alvao.API.Common.Model.Database.Webhook GetById(int webhookId) { throw new NotImplementedException(); }
    ...
    public static Alvao.API.Common.Model.Database.WebhookTopic GetTopicById(int topicId) { throw new NotImplementedException(); }
    ...
    public static void WhenObjectCreated(int objectId) { throw new NotImplementedException(); }
    ...
    public static void WhenObjectMoved(int objectId, int? oldParentObjectId) { throw new NotImplementedException(); }
    ...
    public static void WhenObjectPropertyChanged(int objectId, int propertyKindId) { throw new NotImplementedException(); }
    ...
    public static void WhenRequestFieldChanged(int ticketId, int personId, IEnumerable<string> changedFields) { throw new NotImplementedException(); }
}
