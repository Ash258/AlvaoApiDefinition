...
public static class ProfileValue {
    ...
    /// Throws when personId is less or equal to 0 or valueName is null or empty.
    /// </exception>
    public static void Delete(string valueName, string stringValue = null, int? personId = null, int? intValue = null, bool backup = false) { throw new System.NotImplementedException(); }
    ...
    public static Alvao.API.Common.Model.Database.ProfileValue Get(int personId, string valueName, bool backup = false) { throw new System.NotImplementedException(); }
    ...
    public static bool? GetTableDisplayMode(int personId, string valueName) { throw new System.NotImplementedException(); }
    ...
    /// Throws when personId is less or equal to 0 or valueName is null or empty.
    /// </exception>
    public static void InsertOrUpdate(int personId, string valueName, string stringValue, int? intValue, bool backup = false) { throw new System.NotImplementedException(); }
    ...
    /// Throws when personId is less or equal to 0 or valueName is null or empty.
    /// </exception>
    public static void SetTableDisplayMode(int personId, string valueName, bool value) { throw new System.NotImplementedException(); }
}
