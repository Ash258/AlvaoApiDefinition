...
public static class Person {
    ...
    public static void AddToGroup(int personId, IEnumerable<int> roleIds) { throw new NotImplementedException(); }
    ...
    public static DateTime ConvertUtcToPersonLocal(tPerson person, DateTime utcDate) { throw new NotImplementedException(); }
    ...
    public static int Create(string fullName, string login, string email, string phone, string personalNumber, string azureAdObjectId = null, int? azureAdTenantId = null) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tPerson> GetAll(bool includeRemoved = false) { throw new NotImplementedException(); }
    ...
    public static tPerson GetByAzureIdSidOrEmail(string azureAdObjectId, string userSid = null, string email = null) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tPerson> GetByAzureTenant(int azureAdTenantId) { throw new NotImplementedException(); }
    ...
    public static tPerson GetByEmail(string email) { throw new NotImplementedException(); }
    ...
    public static tPerson GetById(int personId) { throw new NotImplementedException(); }
    ...
    public static tPerson GetByLogin(string login) { throw new NotImplementedException(); }
    ...
    public static CultureInfo GetCultureInfoOrDefault(tPerson person) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<dynamic> GetCustomList(string columns, string filterCondition, string sorting) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<int> GetGroupMembership(int personId, bool onlyDirectMembership) { throw new NotImplementedException(); }
    ...
    public static tPerson GetGuest() { throw new NotImplementedException(); }
    ...
    public static string GetNameFromMail(string email, string displayName) { throw new NotImplementedException(); }
    ...
    public static tPerson GetPersonByEmail(string email) { throw new NotImplementedException(); }
    ...
    public static tPerson GetPersonById(int personId) { throw new NotImplementedException(); }
    ...
    public static CultureInfo GetPersonCultureInfoOrDefault(tPerson person) { throw new NotImplementedException(); }
    ...
    public static tPerson GetSystem() { throw new NotImplementedException(); }
    ...
    public static string GetTimezone(tPerson person) { throw new NotImplementedException(); }
    ...
    public static string GetToken(int personId, string scope) { throw new NotImplementedException(); }
    ...
    public static int? GetUserNodeIdByPersonId(int personId) { throw new NotImplementedException(); }
    ...
    public static void InsertToEmailUsage(int personId, string email) { throw new NotImplementedException(); }
    ...
    public static bool IsMemberOfGroup(int personId, int roleId) { throw new NotImplementedException(); }
    ...
    public static void RecomputePersonManager() { throw new NotImplementedException(); }
    ...
    /// <param name="personId">Person ID (tPerson.iPersonId)</param>
    /// <param name="roleId">Group ID (tRole.iRoleId)</param>
    public static void RemoveFromGroup(int personId, int roleId) { throw new NotImplementedException(); }
    ...
    public static void Update(tPerson person) { throw new NotImplementedException(); }
}
