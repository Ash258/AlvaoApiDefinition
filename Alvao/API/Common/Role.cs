...
public static class Role {
    ...
    public static void AddToRole(int addedRoleId, int intoRoleId) { throw new System.NotImplementedException(); }
    ...
    public static tRole GetByAzureObjectId(string azureAdObjectId) { throw new System.NotImplementedException(); }
    ...
    /// <returns>Role model (tRole)</returns>
    public static tRole GetByName(string name) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<tRole> GetDirectMemberRoles(int roleId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<int> GetDirectMemberUserIds(int roleId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<tPerson> GetDirectMemberUsers(int roleId) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<tPerson> GetMembers(int roleId, bool includeRemoved = false, bool includeDisabled = false, bool includeHidden = false, bool onlyWithEmail = false) { throw new System.NotImplementedException(); }
    ...
    public static IEnumerable<int> GetRequestIdsSolvingByGroups(IEnumerable<int> roleIds, bool onlyWithoutSolver = false) { throw new System.NotImplementedException(); }
    ...
    /// <returns>Role model (tRole)</returns>
    public static tRole GetSystemRole(RoleBehavior.BehaviorId roleBehavior) { throw new System.NotImplementedException(); }
    ...
    public static bool IsMemberOfAnotherRole(int roleId, int? memberRoleId = null, int? roleBehaviorId = null) { throw new System.NotImplementedException(); }
    ...
    public static void RemoveFromRole(int removedRoleId, int fromRoleId) { throw new System.NotImplementedException(); }
