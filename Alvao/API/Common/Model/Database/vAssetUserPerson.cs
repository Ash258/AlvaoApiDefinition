...
/// <summary>The user's link in the object tree to the user in the Administration service (tPerson.Link based on priority:1. AD GUID2. Personal number3. Login name4. E-mail</summary>
