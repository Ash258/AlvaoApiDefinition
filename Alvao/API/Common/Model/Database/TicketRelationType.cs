...
public class TicketRelationType
{
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_BeginName.htm"/>
    public virtual string BeginName { get; set; }
    /// <summary>Custom field</summary>
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_CustomField1.htm"/>
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_Cyclic.htm"/>
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_Directional.htm"/>
    public virtual bool Directional { get; set; }
    /// <summary>The name of the link from the ticket view at the end of the link</summary>
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_EndName.htm"/>
    public virtual string EndName { get; set; }
    /// <summary>Record ID</summary>
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_id.htm"/>
    [KeyAttribute]
    public virtual int id { get; set; }
    /// <summary>The order of link types in menus</summary>
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_MenuOrder.htm"/>
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_OneToMany.htm"/>
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/P_Alvao_API_Common_Model_Database_TicketRelationType_TicketRelationTypeBehaviorId.htm"/>
    public virtual int TicketRelationTypeBehaviorId { get; set; }

    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/M_Alvao_API_Common_Model_Database_TicketRelationType__ctor.htm"/>
