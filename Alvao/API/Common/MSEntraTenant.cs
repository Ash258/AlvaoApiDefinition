...
public class MSEntraTenant {
    ...
    public static IEnumerable<AzureAdTenant> GetAll() { throw new System.NotImplementedException(); }
    ...
    /// <returns>List of all tenants (AzureAdTenant)</returns>
    public static IEnumerable<AzureAdTenant> GetByFeature(MSEntraTenant.Feature feature) { throw new System.NotImplementedException(); }
    ...
    public static AzureAdTenant GetById(int tenantId) { throw new System.NotImplementedException(); }
    ...
    public static string GetForLogin() { throw new System.NotImplementedException(); }
    ...
    public static bool IsFeatureEnabled(MSEntraTenant.Feature feature) { throw new System.NotImplementedException(); }
    ...
    public static bool IsFeatureEnabled(MSEntraTenant.Feature feature, int tenant) { throw new System.NotImplementedException(); }
}
