...
public static class Scim {
    ...
    public static int CreateUser(string userName, string adGuid, string email, IDictionary<tblKind.KindCode, dynamic> properties, IDictionary<int, dynamic> extensionProperties) { throw new NotImplementedException(); }
    ...
    public static string GetAccountDisabledStringValue(bool disabled) { throw new NotImplementedException(); }
    ...
    public static IDictionary<int, dynamic> GetUserProperties(int personId, IEnumerable<int> properties) { throw new NotImplementedException(); }
    ...
    public static bool IsImportEnabled() { throw new NotImplementedException(); }
    ...
    /// <exception cref="UnauthorizedAccessException">Throws when method is called elsewhere than in the SCIM user import.</exception>
    public static void UpdateUser(int personId, IDictionary<tblKind.KindCode, dynamic> properties, IDictionary<int, dynamic> extensionProperties) { throw new NotImplementedException(); }
}
