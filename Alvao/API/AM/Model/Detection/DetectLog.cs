...
public class DetectLog {
    ...
    public static void Add(IDetectionRepository detectionRepository, tString.Id stringId, tblDetect detect, int personId, params string[] parameters) { throw new System.NotImplementedException(); }
    ...
    public static void Add(IDetectionRepository detectionRepository, tString.Id stringId, int nodeId, Detection.Kind detectionKind, int personId, params string[] parameters) { throw new System.NotImplementedException(); }
    ...
    public static void Add(IDetectionRepository detectionRepository, tString.Id stringId, int detectId, int? nodeId, int personId, params string[] parameters) { throw new System.NotImplementedException(); }
