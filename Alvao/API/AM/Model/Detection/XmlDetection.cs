...
public class XmlDetection : XmlDocument, IEnumerable, ICloneable, IXPathNavigable {
    ...
    public static string ElementStringValue(XmlDocument xml, string xpath) { throw new System.NotImplementedException(); }
    ...
    public static string EncodeInvalidXmlChars(MemoryStream xmlStream) { throw new System.NotImplementedException(); }
    ...
    public DetectionInfo Load(MemoryStream xmlStream, ScanLoadSettings loadSettings, CancellationToken cancellationToken) { throw new System.NotImplementedException(); }
