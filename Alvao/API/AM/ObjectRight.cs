...
public static class ObjectRight {
    ...
    public static bool CanNodePersonRead(int personNodeId, int personId, int objectId) { throw new System.NotImplementedException(); }
    ...
    public static void Delete(int id, int authorId) { throw new System.NotImplementedException(); }
