...
public static class License {
    ...
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage the license.</exception>
    public static void AddOrUpdateProduct(int licenseId, int productId, string notes) { throw new NotImplementedException(); }
    ...
    public static void AddOrUpdateRelation(int sourceLicenseId, int targetLicenseId, int relationTypeId, int relationId = 0) { throw new NotImplementedException(); }
    ...
    /// <exception cref="LicenseAlreadyAssignedException">Throws when license is already assigned to the object.</exception>
    /// <exception cref="LicenseException">Throws when any assignment property has forbidden value.</exception>
    public static void Assign(tblLicHistItem assignment) { throw new NotImplementedException(); }
    ...
    public static int AutoAssign(int? objectId = null, int? licenseId = null, int? personId = null) { throw new NotImplementedException(); }
    ...
    public static int AutoRelease(int? objectId = null, int? licenseId = null, int? personId = null) { throw new NotImplementedException(); }
    ...
    public static bool CanUserManage(int licenseId, int? personId = null) { throw new NotImplementedException(); }
    ...
    public static bool CanUserManageAny(int? personId = null) { throw new NotImplementedException(); }
    ...
    /// <param name="personId">User ID (tPerson.iPersonId) if not specified its current user id.</param>
    /// <returns>True, if the user has the right to manage the license.</returns>
    public static bool CanUserManageInOrganization(int? nodeId, int? personId = null) { throw new NotImplementedException(); }
    ...
    public static bool CanUserRead(int licenseId, int? personId = null) { throw new NotImplementedException(); }
    ...
    public static bool CanUserReadAny(int? personId = null) { throw new NotImplementedException(); }
    ...
    /// <exception cref="LicenseException">Throws when any license property has forbidden value.</exception>
    public static int CreateOrUpdate(tblLicHist license) { throw new NotImplementedException(); }
    ...
    /// <param name="personId">User ID (tPerson.iPersonId) recorded in object log.</param>
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage the license.</exception>
    public static void DeleteAssignment(int licItemId, int? personId = null) { throw new NotImplementedException(); }
    ...
    /// <param name="assignment">Db model of assignment. Should contain License Id (tblLicHist.intLicHistId)</param>
    /// <exception cref="LicenseException">Throws when any assignment property has forbidden value.</exception>
    public static void EditAssignment(tblLicHistItem assignment) { throw new NotImplementedException(); }
    ...
    /// <exception cref="LicenseNotFoundException">Throws when license was not found.</exception>
    public static tblLicHist GetById(int id) { throw new NotImplementedException(); }
    ...
    public static tblLicHistItem GetItemById(int licenseItemId) { throw new NotImplementedException(); }
    ...
    public static tblLicTrans GetShared(int productId, int objectId) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tblLicHistItem> GetValidItems(int licenseId) { throw new NotImplementedException(); }
    ...
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage the license.</exception>
    /// <exception cref="LicenseAlreadyAssignedException">Throws when license is already assigned to the object.</exception>
    public static void Move(int licItemId, int? targetObjectId = null, string targetCostCenter = null) { throw new NotImplementedException(); }
    ...
    /// <param name="personId">User ID (tPerson.iPersonId) recorded in object log.</param>
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage the license.</exception>
    public static void Release(int licItemId, int? personId = null) { throw new NotImplementedException(); }
    ...
    public static void RemoveRelation(int sourceLicenseId, int relationId) { throw new NotImplementedException(); }
    ...
    public static void RemoveSharing(int productId, int objectId) { throw new NotImplementedException(); }
    ...
    public static void Share(int productId, int objectId, int licenseObjectId, string note) { throw new NotImplementedException(); }
    ...
    /// <exception cref="ArgumentException">Throws when license with ID licenseId doesn't exist.</exception>
    public static void UpdateCount(int licenseId, int count) { throw new NotImplementedException(); }
}
