...
public static class Object
{
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/M_Alvao_API_AM_Object_CopyObject.htm"/>
    /// <param name="personId">Person ID (who copied object) (tPerson.iPersonId)</param>
    /// <param name="objectId">Object ID (tblNode.intNodeId)</param>
    /// <param name="destinationObjectId">ID of object which will be parent (tblNode.intNodeId)</param>
    [ObsoleteAttribute("CopyObject is deprecated, please use Copy instead.")]
    public static int CopyObject(
        int personId,
        int objectId,
        int destinationObjectId
    )
    ...
    /// <summary>Create new object as a copy of object. CreateObject is deprecated, please use Create instead.</summary>
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/M_Alvao_API_AM_Object_CreateObject.htm"/>
    /// <param name="personId">Person ID (who copied object) (tPerson.iPersonId)</param>
    /// <param name="objectId">Object ID (tblNode.intNodeId)</param>
    /// <param name="destinationObjectId">ID of object which will be parent (tblNode.intNodeId). Null for root</param>
    [ObsoleteAttribute("CreateObject is deprecated, please use Create instead.")]
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/M_Alvao_API_AM_Object_DeleteObject.htm"/>
    /// <param name="personId">Person ID (who deleted object) (tPerson.iPersonId)</param>
    /// <param name="objectId">Object ID (tblNode.intNodeId)</param>
    /// <param name="callCustomAction">If true, object auto actions are triggered. Default value is true.</param>
    [ObsoleteAttribute("DeleteObject is deprecated, please use Delete instead.")]
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/M_Alvao_API_AM_Object_GetObjectById.htm"/>
    /// <param name="personId">Person Id (for access check) (tPerson.iPersonId)</param>
    /// <param name="objectId">Object ID (tblNode.intNodeId)</param>
    [ObsoleteAttribute("GetObjectById is deprecated, please use GetById instead.")]
    public static tblNode GetObjectById(
        int personId,
        int objectId
    )
    { throw new System.NotImplementedException(); }
    ...
    /// <see href="https://doc.alvao.com/en/alvao_11_2/alvao_api/html/M_Alvao_API_AM_Object_MoveObject.htm"/>
    /// <param name="personId">Person ID (who moved object) (tPerson.iPersonId)</param>
    /// <param name="objectId">Object ID (tblNode.intNodeId)</param>
    /// <param name="destinationObjectId">ID of object which will be parent (tblNode.intNodeId)</param>
    /// <param name="callCustomAction">If true, object auto actions are triggered. Default value is true.</param>
    [ObsoleteAttribute("MoveObject is deprecated, please use Move instead.")]
