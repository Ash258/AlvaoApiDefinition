...
public static class ObjectProperty {
    ...
    public static void Add(int objectId, int kindId, object value, bool inheritable) { throw new NotImplementedException(); }
    /// <summary>Adds property to object template.</summary>
    ...
    public static void Add(int objectId, int kindId, object value, int? order, bool inheritable) { throw new NotImplementedException(); }
    ...
    public static tblKind GetDefinition(int propertyKindId) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tblKindValue> GetPosibleValues(Property property) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tblKind> GetTemplateProperties(tblClass.ClassCode classCode) { throw new NotImplementedException(); }
    /// <summary>Return template properties for specific object kind.</summary>
    ...
    public static IEnumerable<tblKind> GetTemplateProperties(int typeId) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<tblKindValue> GetValueList(int kindId = 0, int kindCode = 0) { throw new NotImplementedException(); }
    ...
    public static bool TemplateContains(int classId, tblKind.KindCode kindCode) { throw new NotImplementedException(); }
    ...
    /// <exception cref="MissingPropertyException">Throws when object with objectId doesn't have property with kindCode.</exception>
    ...
    public static void Update(int objectId, tblKind.KindCode kindCode, object value, bool callCustomAction = true, bool shouldLog = true) { throw new NotImplementedException(); }
    /// <summary>
    ...
    public static void Update(int personId, int objectId, IDictionary<string, string> properties, bool callCustomAction = true) { throw new NotImplementedException(); }
    /// <summary>
    ...
    public static void UpdateProperties(int personId, int objectId, IDictionary<string, string> properties, bool callCustomAction = true) { throw new NotImplementedException(); }
}
