...
using Alvao.API.AM.Model.CsvImport;
...
public static class ImportCsv {
    ...
    /// <see href="https://doc.alvao.com/en/25/alvao-api/api/Alvao.API.AM.ImportCsv.html#Alvao_API_AM_ImportCsv_GetImportColumnsInfo_Alvao_API_AM_Model_CsvImport_ImportCsvSettings_"/>
    ...
    /// <see href="https://doc.alvao.com/en/25/alvao-api/api/Alvao.API.AM.ImportCsv.html#Alvao_API_AM_ImportCsv_Run_Alvao_API_AM_Model_CsvImport_ImportCsvSettings_"/>
    /// <param name="settings">Multiple settings of import</param>
    /// <exception cref="ArgumentNullException">Throws when settings is null.</exception>
    ...
    /// <see href="https://doc.alvao.com/en/25/alvao-api/api/Alvao.API.AM.ImportCsv.html#Alvao_API_AM_ImportCsv_RunImportCsv_Alvao_API_AM_Model_CsvImport_ImportCsvSettings_"/>
    /// <param name="settings">Multiple settings of import</param>
    /// <exception cref="ArgumentNullException">Throws when settings is null.</exception>
    /// <exception cref="ArgumentException">Throws when data in CSV file are not valid.</exception>
    /// <returns>True if import CSV was succesfull, otherwise False.</returns>
