...
public static class SoftwareProfile {
    ...
    public static tSwProfile GetById(int id) { throw new NotImplementedException(); }
    ...
    public static IEnumerable<ObjectSoftwareProfileException> GetObjectsExceptions(IEnumerable<int> objectIds) { throw new NotImplementedException(); }
    ...
    public static void Set(IEnumerable<int> objectIds, bool allowAllSoftware, int? profileId, IEnumerable<SoftwareProfileException> exceptions) { throw new NotImplementedException(); }
}
