...
public static class ObjectRelation {
    ...
    /// Throws when person with personId doesn't have rights to manage object relation.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Throws when object with beginObjectId is same as object with endObjectId
    /// </exception>
    /// <exception cref="ObjectRelationConditionViolatedException">
    /// Throws when object relation cannot be created due to a condition violation (eg. cyclicity, one to many or duplicate).
    /// </exception>
    ...
    /// Throws when object relation with relationId cannot be edited because it is already removed.
    /// </exception>
    /// <exception cref="ObjectRelationConditionViolatedException">
    /// Throws when object relation with relationId cannot be edited due to a condition violation (eg. cyclicity, one to many or duplicate).
    /// </exception>
    ...
    /// </exception>
    /// <exception cref="InvalidOperationException">
    /// Throws when object relation with relationId is already removed.
    /// </exception>
