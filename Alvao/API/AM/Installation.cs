...
public static class Installation {
    ...
    public static tblInstTrial GetSpecial(int productId, int objectId) { throw new NotImplementedException(); }
    ...
    public static void Install(int productId, int objectId, string note) { throw new NotImplementedException(); }
    ...
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage licenses.</exception>
    public static void MarkAsSpecial(int productId, int objectId, string note, DateTime? validUntil) { throw new NotImplementedException(); }
    ...
    /// <param name="objectId">Object ID (tblNode.intNodeId)</param>
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage licenses.</exception>
    public static void RemoveSpecial(int productId, int objectId) { throw new NotImplementedException(); }
    ...
    /// <exception cref="UnauthorizedAccessException">Throws when user does not have rights to manage licenses.</exception>
    public static void Uninstall(IEnumerable<int> installationIds) { throw new NotImplementedException(); }
}
