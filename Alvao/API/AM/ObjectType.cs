...
public static class ObjectType {
    ...
    public static void Edit(int id, string name, int? iconId, string objectNameTemplate) { throw new System.NotImplementedException(); }
    ...
    public static int? GetDefaultTemplateId(int objectTypeId) { throw new System.NotImplementedException(); }
    ...
    public static int GetDeviceTypeId(string hostname, string model, int chassisTypesId) { throw new System.NotImplementedException(); }
    ...
    public static void RecalcObjectName_Type(int objectTemplateId) { throw new System.NotImplementedException(); }
}
