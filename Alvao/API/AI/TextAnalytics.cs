...
public static class TextAnalytics {
    ...
    public static IEnumerable<string> ExtractKeyPhrases(string text) { throw new NotImplementedException(); }
    ...
    public static string ExtractKeyPhrasesString(string text) { throw new NotImplementedException(); }
}
